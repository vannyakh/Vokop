...
/**
 * While active, disable pointer events everywhere except the locked container
 * (and an optional allow-listed selector), and dismiss on outside pointerdown.
 * Prevents stray hover/click side effects while a field is being edited.
 */
