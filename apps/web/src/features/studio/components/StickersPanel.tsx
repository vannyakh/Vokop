...
function StickerCategorySection({
  ...
  }, [category.id, category.query, giphyEnabled]);
...
export function StickersPanel() {
  ...
  const giphyEnabled = mediaStatus?.giphy ?? false;
  ...
  return (
    <div className="stickers-panel">
      ...
      {!statusPending && !giphyEnabled && (
        <p className="stickers-api-hint">
          Add <code>GIPHY_API_KEY</code> to your server <code>.env</code> for live sticker search.
        </p>
      )}
